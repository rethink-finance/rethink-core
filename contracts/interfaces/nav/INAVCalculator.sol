...
interface INAVCalculator {
	function liquidCalculation(IGovernableFund.NAVLiquidUpdate[] calldata liquid, address safe, address fund, uint256 navEntryIndex) external view returns (uint256);
